...
export const all_windows: IWindow[] = [
	{title: "who am i?", icon: who, isActive: false, windowElement: WhoAmI},
	{title: "toolbox", icon: toolbox, isActive: false, windowElement: ToolBox},
	{title: "projects", icon: projects, isActive: false, windowElement: Projects},
	{title: "say hi!", icon: mail, isActive: false, windowElement: SayHi},
	{title: "my resume", icon: pdf, isActive: false, windowElement: Resume},
]